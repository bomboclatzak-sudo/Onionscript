...
function Fatality.new(Window: Window)
	Window = Window or {};
	Window.Name = Window.Name or '<font color="#FFFFFF">onion</font><font color="#FFFF00">script</font>';
	...
	-- remove previous window if present
	if _G.EvilHubWindow and _G.EvilHubWindow.Destroy then
		_G.EvilHubWindow:Destroy()
		_G.EvilHubWindow = nil
	end
